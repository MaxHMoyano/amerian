...
import { staffActions, hotelActions, positionActions } from "../../../redux/actions/";
...
const Staff = () => {
  ...
  return (
    <Fragment>
      <StaffModal selected={selectedStaff} onClose={() => { setshowModal(false); setSelectedStaff({}); }} show={showModal} />
      <DeleteStaff selected={selectedStaff} onClose={() => { setshowDeleteModal(false); setSelectedStaff({}); }} show={showDeleteModal} />
      <div className="d-flex mb-4 align-items-center">
        ...
        <Select
          ...
          onChange={value => setSearchParams({ ...searchParams, position: value ? value.value : null })}
        />
      </div>
      {
                  ...
                  <td>
                    <div className="d-flex align-items-center">
                      <div className="d-flex flex-column">
                        <p className="mb-0">{staff.first_name} {staff.last_name}</p>
